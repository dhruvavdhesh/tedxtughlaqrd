				<section id="section-partners" class="page-section section dark">
				...
				<section id="section-contact" class="page-section section dark nomargin" style="background: url('images/6.jpg') no-repeat center center; background-size: cover;">
					<div class="container clearfix">
		...
		<footer id="footer" class="noborder dark">
			<div id="copyrights" class="center notoppadding" style="background: url('images/7.jpg') no-repeat center center; background-size: cover;">
				<div class="container clearfix">
					<div class="col-md-12 center">
	...
	<script src="js/talks.min.js"></script>
